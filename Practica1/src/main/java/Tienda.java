...
public class Tienda implements Serializable {
    ...
    public boolean realizarVenta(Cliente comprador, PersonalCajero cajero, PersonalPromotor promotor, Libro libro){
        Venta nueva = null;
    ...
    public String mostrarLibroDelAutor(String autor){
        ...
        return librosDelAutor.toString();
    }
    ...
    public String librosNoDisponibles(){
        ...
        return librosNoDisponibles.toString();
    }

    private void esDisponibleADescuento(long ci){
